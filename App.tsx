             ...
             <main className="flex-1 flex flex-col min-h-0 bg-white/50 relative overflow-hidden backdrop-blur-[2px]">
                 ...
                 {activeTab === 'tanggungan' && (
                     <MonitoringView 
                        type="tanggungan" 
                        students={students} 
                        history={userRole === 'teacher' 
                            ? assessmentHistory.filter(h => teacherSubjects.includes(h.targetSubject || 'Pendidikan Agama Islam')) 
                            : assessmentHistory
                        } 
                        currentSemester={settings.activeSemester} 
                        academicYear={settings.academicYear} 
                        subjectName={userRole === 'teacher' ? teacherSubjects.join(", ") : "Semua Mapel"} 
